...
fun NoteScreen(navController: NavController, viewModel: MainViewModel, noteId: String?) {
    ...
    var title by remember { mutableStateOf(Constants.Keys.NONE) }
            ...
            Surface {
                Column(modifier = Modifier
                    ...
                    Button(
                        ...
                        Text(text = Constants.Keys.UPDATE)// Update Button BottomSheet
                    }
            ...
            Column(
                ...
                Row(
                    ...
                    Button(onClick = {
                        ...
                        Text(text = Constants.Keys.UPDATE)// Update Note
                    }
